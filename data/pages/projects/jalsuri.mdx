...
<Gallery
  grid={{
    className: 'grid-cols-[1.55fr_1fr] gap-1',
  }} 
  pictures={
    [
      {
...
<Gallery
  grid={{
    className: 'grid-cols-[1fr_1.04fr_0.985fr] grid-rows-[auto_auto] gap-1',
  }} 
  pictures={
    [
      {
...
<Gallery
  grid={{
    className: 'grid-cols-[1fr_1.11fr] grid-rows-[1fr_1fr] gap-1',
  }} 
  pictures={
    [
      {
...
<Gallery
  grid={{
    className: 'grid-cols-[1.12fr_1fr] gap-1',
  }} 
  pictures={
    [
      {
